...
import com.xiyan.mianshihou.model.dto.questionBank.QuestionBankAddRequest;
import com.xiyan.mianshihou.model.dto.questionBank.QuestionBankEditRequest;
import com.xiyan.mianshihou.model.dto.questionBank.QuestionBankQueryRequest;
import com.xiyan.mianshihou.model.dto.questionBank.QuestionBankUpdateRequest;
...
//        String key = HotKeyConstant.HOT_BANK_KEY + id;
//        // 如果是热 key
...
//        JdHotKeyStore.smartSet(key, questionBankVO);
     ...
     * 限流：提示“系统压力过大，请耐心等待”
     * 熔断：执行降级操作
     * handleBlockException是处理sentinel的异常，包括限流和熔断等
     */
